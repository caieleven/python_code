...
class Customer:
    ...
    def placeOrder(self):
        self.myEmployee.ShowFood()
        self.myEmployee.takeOrder()
        self.myEmployee.ShowOrder()
...
class Employee:
    ...
    def takeOrder(self):
        ...
        self.order.ChooseDisher(sequence, num)

    def ShowOrder(self):
        print("这是您所点的食物：")
        self.order.ShowSelected()
